...
public record ReviewDTO(String id, String author, String text, Double rating, String date,
        ...
        LocalDateTime collectedAt, Long establishmentId, String establishmentName, List<AspectDTO> aspects) {
    ...
    public static ReviewDTO from(Review review) {
        return new ReviewDTO(review.getId(), review.getAuthor(), review.getText(), review.getRating(),
                ...
                review.getEstablishment() == null ? null : review.getEstablishment().getId(),
                review.getEstablishment() == null ? null : review.getEstablishment().getName(),
